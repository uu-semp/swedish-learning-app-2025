export const WardrobeContainer = {
  ...
  methods: {
    ...
    // When you start dragging something, the item’s data is stored in the drag event (as JSON), 
    // and the browser knows the operation is a "move" 
    // event is handled by methods in LevelOneView
