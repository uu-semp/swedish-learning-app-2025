  ...
  methods: {
    buttonStyle(index) {
      ...
      if (index === this.selectedOption && index === this.correctIndex) {
        return { backgroundColor: "#4caf50", color: "white", border: "4px dashed  black" }; // correct
      ...
      return { backgroundColor: "#4caf50", color: "white", border: "4px dashed  black" }; // show correct answer
      } else {
        return {};
      }
    }
